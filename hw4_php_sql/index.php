...
$name = "Andrey";
$profession = 'крановщик';
$city = 'Тюмень';
$email = 'andreykran@mail.ru';
$phone = '89123004021';
...
$experience = [
    [
        'job_title' => 'Бекенд-разработчик',
        'period' => 'янв 2020 - <span class="w3-tag w3-teal w3-round">Current</span>',
        'description' => 'Очень много и хорошо работал бекенд-разработчиком',
    ],
    [
        'job_title' => 'Фронтенд-разработчик',
        'period' => 'янв 2018 - дек 2019',
        'description' => 'Очень много и хорошо работал фронтенд-разработчиком',
    ],
    [
        'job_title' => 'Дизайнер',
        'period' => 'янв 2017 - дек 2018',
        'description' => 'Очень много и хорошо работал дизайнером',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($experience); $i++):?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?php echo $experience[$i]['job_title'];?></b></h5>
